...
| LS-B008 | 2026-08-27 | Medium | Support and demonstrate orders with different final destinations and ship-tos. | The UI distinguishes the current trip destination from each order's final ship-to and uses illustrative records with different final ship-tos. Confirm whether different ship-tos may share one trip before implementation. | Explicit user notes; conflicts with current mockup decision LS-D002 |
| LS-B009 | 2026-08-27 | Medium | Create a realistic cross-island order example with trip and vehicle handoffs. | Illustrative data demonstrates a Cikarang or Jakarta origin, a Surabaya transfer and a Bali, Mataram or Makassar destination using truck and ferry or ship legs, with linked orders and trips. | Live Status Workshop transcript, 00:01:12 to 00:05:24; meeting notes |
...
| LS-B011 | 2026-08-27 | Medium | Verify the STO and SO mapping and mixed-load presentation. | The approved mapping defines how Stock Transfer Orders and Sales Orders appear and whether both may be carried within one trip. | Live Status Workshop transcript, 00:10:12 to 00:11:25; meeting notes |
