...
CEL, YCH Transport Control Tower, SPVB Vietnam. Version 6, 3 September 2026. Owner: Pierre.
...
└── 05. Product
    ...
    │   ├── Ways of Working/              this file. One current .md,
    │   │   └── Archive/                  superseded versions in Archive
    │   ├── Index/                        one sheet, what is current
    │   ├── Backlog/                      one register, every idea
...
**One master mockup is the exception.** `05. Product/00. Global/Mockup/Released` holds the current master only. Every build sits in `05. Product/00. Global/Mockup/Working` until Pierre says it is ready for the pods to copy from, and only then is it promoted.
...
- **Decisions** go in the working file, which lives in `05. Product/00. Global/Decisions`, with what was traded away.
